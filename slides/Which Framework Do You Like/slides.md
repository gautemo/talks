...
<BarChart title="Merged" :bars="[
  { name: 'React', points: ([32.5,66.2,29.4,68.2,53.3].reduce((acc, p) => acc + p, 0)/5).toFixed(1) }, 
  { name: 'Vue', points: ([20.7,13.5,31,28,14.5].reduce((acc, p) => acc + p, 0)/5).toFixed(1) }, 
  { name: 'Angular', points: ([22,12.6,12.8,2.2,30.7].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Svelte', points: ([8.1,1.1,9.1,0.3,0.4].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Preact', points: ([5.7,4.8,5,0.2,0].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Ember', points: ([3.7,0,3.5,0.9,0.9].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Lit', points: ([2.8,0.5,1.8,0,0].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Alpine', points: ([2.4,0.4,3.2,0.2,0].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Solid', points: ([1.2,0.1,2.6,0,0].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  { name: 'Stimulus', points: ([0.8,0.7,1.8,0,0].reduce((acc, p) => acc + p, 0)/5).toFixed(1) },
  ]"/>
